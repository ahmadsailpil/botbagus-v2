 ...
 *Powered By @${'6283160327945'.split('@')[0]}*`
 ...
   "productImage":{ 
   "mimetype": "image/jpeg", 
   "jpegThumbnail": await (await fetch('https://telegra.ph/file/5cd3cc7381bce4a4a65ec.jpg')).buffer(), //Gambarnye
     }, 
   "title": `${ucapan()}`, 
 ...
     }) 
     if (teks == '404') {
 	let cute = `${pickRandom(['https://telegra.ph/file/989bd78701f27eec3293a.png.jpg', 'https://telegra.ph/file/989bd78701f27eec3293a.png', 'https://telegra.ph/file/989bd78701f27eec3293a.png', 'https://telegra.ph/file/989bd78701f27eec3293a.png','https://telegra.ph/file/989bd78701f27eec3293a.png','https://telegra.ph/file/989bd78701f27eec3293a.png', 'https://telegra.ph/file/989bd78701f27eec3293a.png', 'https://telegra.ph/file/989bd78701f27eec3293a.png', 'https://telegra.ph/file/989bd78701f27eec3293a.png'])}` 
 	let ori = `Hi Kak, @${m.sender.split`@`[0]}
 
Saya Adalah Asep Bot Salah Satu Bot Whatsapp Yang Siap Membantu Kamu Mempermudah Sesuatu Seperti Membuat Sticker Dan Lainnya, Kalo Kamu Mau Request Fitur Silahkan Ketik #request Pesan Atau Fitur Yang Kamu Inginkan!`
...
return conn.send3ButtonLoc(m.chat, await conn.resize(pickRandom(global.waifu), 300, 300), ori, `Note : Jika Anda Menggunakan Wa Lama Atau Mod Dan Tombol Itu Tidak Terlihat Langsung Ketik ${_p}simplemenu`, 'MENU', '.simplemenu', 'DONASI', '.donasi', 'RENT BOT', '.sewa', m)
...
type: 'audioMessage', 
ptt: true, contextInfo:{ externalAdReply: { title: `💌 Ultah ridho : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`, body: `${pickRandom(['Follow Tiktok My Bestie'])}`, sourceUrl: 'https://www.tiktok.com/@m_ridho_gg?_t=8V5TGON5rgv&_r=1', thumbnail: await (await fetch('https://telegra.ph/file/989bd78701f27eec3293a.png')).buffer(),}} 
     })
} catch (e) { 
