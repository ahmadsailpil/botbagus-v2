...
ptt: true, contextInfo: {
        externalAdReply: { showAdAttribution: true, title: 'Nih Kak', body: `${pickRandom(['Follow Tiktok My Bestie'])}`, sourceUrl: 'https://www.tiktok.com/@m_ridho_gg?_t=8V5TGON5rgv&_r=1', thumbnail: await (await fetch('https://telegra.ph/file/b25cf88fd52d63ca47c49.jpg')).buffer(),}} 
     })
		}
}
handler.tags = ['maker']
