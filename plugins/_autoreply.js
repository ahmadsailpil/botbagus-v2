let fs = require('fs') 
 ...
         this.sendTemplate2ButtonLoc(m.chat, 'https://telegra.ph/file/5cd3cc7381bce4a4a65ec.jpg', `┌「 *Undang Bot ke Grup* 」 
 ├ 7 Hari / Rp 5,000 
 ├ 30 Hari / Rp 15,000 
 └──── 
 ...
     } 
      
     if (/@6283160327945$/i.test(m.text)) { 
 ...
        await this.setBio(`
⏲️ Runtime: ${uptime} | 🛰 Mode: ${global.opts['self'] ? 'Private' : setting.groupOnly ? 'Only Group' : 'Public'} | 💌 Made 𝐑𝐈𝐃𝐇𝐎 𝐆𝐀𝐍𝐙`).catch(_ => _)  
